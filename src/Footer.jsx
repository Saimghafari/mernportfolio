...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: FaMapMarkerAlt, text: 'Faisalabad' },
    { icon: FaPhoneAlt, text: '+92 313-7679286' },
    { icon: FaEnvelope, text: 'ahtixham786@gmail.com' },
  ];
  ...
  return (
    <footer className="bg-gray-900 text-white py-12 mt-0 footer">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-12 text-center border-t border-gray-700 pt-6">
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <p className="text-gray-400">© 2024 Your Site M.Ahtisham. All Rights Reserved.</p>
